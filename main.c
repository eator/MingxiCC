...
int main(int argc, char *argv[]) {
    ...
    if (syntax_stack->size > 0) {
        warnx(
            "Did not consume the whole syntax stack during parsing! "
            "Remaining:");
